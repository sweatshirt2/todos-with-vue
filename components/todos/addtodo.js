export default {
  template: `
    <div class="mt-8 flex items-center">
      ...
      <select class="bg-gray-300 w-40 p-2 mr-4" v-model="todo.tag">
        <option v-for="tag in tags" :value="tag">{{ tag.tag }}</option>
      </select>
  ...
  methods: {
    addTodo() {
      if (this.todo) {
        ...
        this.todo = { name: "", tag: { tag: "All", id: 1, }, };
      }
    }
  },
  props: {
